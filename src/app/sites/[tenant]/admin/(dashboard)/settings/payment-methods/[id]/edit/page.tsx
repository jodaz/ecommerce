...
export default function EditPaymentMethodPage() {
  ...
  const { paymentMethods, updatePaymentMethod } = useAdminStore();
  ...
  if (!paymentMethod) {
    return (
      <div className="text-center py-20">
        <p className="text-zinc-500">Método de pago no encontrado</p>
        <Link href="/admin/settings" className="text-black font-bold underline mt-4 inline-block">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-zinc-500 mt-2">Actualiza la información del método de pago</p>
      </div>
