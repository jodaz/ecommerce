    ...
    <div className="flex flex-col min-h-screen bg-gray-950 text-white font-sans selection:bg-emerald-500/30">
      ...
      <nav className="flex items-center justify-between px-6 py-6 max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-2">
          <span className="text-2xl font-bold tracking-tight text-white">simple<span className="text-emerald-500">flow</span></span>
        </div>
      ...
      <main className="flex-grow flex flex-col items-center">
        ...
        <section className="w-full max-w-7xl mx-auto px-6 pt-20 pb-32 text-center relative">
          ...
          <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-sm font-medium">
            ✨ Nueva plataforma en Latinoamérica
          </div>
          ...
          <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto text-gray-400 font-light leading-relaxed">
            Únete al primer SaaS de E-commerce Multi-tenant en Latinoamérica y lleva tu negocio al siguiente nivel. Rápido, seguro y escalable.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12 text-sm text-gray-400">
            <div className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> 14 días de prueba</div>
            <div className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> Sin tarjeta de crédito</div>
            <div className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-500" /> Cancela cuando quieras</div>
          </div>
        </section>
        ...
        <section id="pricing" className="w-full max-w-7xl mx-auto px-6 py-24 relative border-t border-gray-900/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-900 border border-gray-800 p-10 rounded-[2rem] relative flex flex-col hover:border-gray-700 transition-colors">
              ...
              <Link href="https://wa.me/584241234567?text=Me%20interesa%20el%20plan%20Emprendedor" target="_blank" className="w-full bg-gray-800 hover:bg-gray-700 text-white py-4 rounded-xl font-bold text-center transition-colors">
                Contactar a Ventas
              </Link>
            </div>
            ...
            <div className="bg-gray-900 border-2 border-emerald-500 p-10 rounded-[2rem] relative flex flex-col transform md:-translate-y-4 shadow-[0_0_40px_rgba(16,185,129,0.15)]">
              ...
              <Link href="https://wa.me/584241234567?text=Me%20interesa%20el%20plan%20Profesional" target="_blank" className="w-full bg-emerald-600 hover:bg-emerald-500 text-white py-4 rounded-xl font-bold text-center transition-colors shadow-[0_0_15px_rgba(16,185,129,0.3)]">
                Contactar a Ventas
              </Link>
            </div>
          </div>
        ...
        <section id="faq" className="w-full max-w-3xl mx-auto px-6 py-24 relative border-t border-gray-900/50">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              { q: "¿Qué métodos de pago soportan?", a: "Soportamos las pasarelas de pago más populares de Latinoamérica, incluyendo Stripe, PayPal, MercadoPago y DLocal." },
      ...
      <footer className="w-full max-w-7xl mx-auto px-6 py-12 border-t border-gray-900">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <span className="text-2xl font-bold tracking-tight text-white mb-4 block">simple<span className="text-emerald-500">flow</span></span>
            <p className="text-gray-500 text-sm leading-relaxed mb-4">
              La plataforma definitiva para escalar tu negocio en línea en toda Latinoamérica.
            </p>
            <div className="flex gap-4">
              <a href="https://jodaz.dev" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm text-gray-500">
              <li><Link href="#" className="hover:text-emerald-400 transition-colors">Términos de Servicio</Link></li>
              <li><Link href="#" className="hover:text-emerald-400 transition-colors">Política de Privacidad</Link></li>
            </ul>
          </div>
        </div>
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-900 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} simpleflow. Todos los derechos reservados.</p>
          <p className="mt-4 md:mt-0 flex items-center gap-1">
            Credits to <a href="https://jodaz.xyz" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:text-emerald-400 transition-colors font-medium">jodaz.xyz</a>
          </p>
        </div>
      </footer>
    </div>
