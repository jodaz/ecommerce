    ...
    <div className="flex flex-col min-h-screen bg-gray-950 text-white font-sans selection:bg-emerald-500/30">
      ...
      <nav className="flex items-center justify-between px-6 py-6 max-w-7xl mx-auto w-full">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-2xl font-bold tracking-tight text-white transition-colors group-hover:text-emerald-500">simple<span className="text-emerald-500 group-hover:text-white">shop</span></span>
        </Link>
      </nav>

      <main className="flex-grow flex flex-col items-center px-6 py-12">
        <div className="w-full max-w-3xl bg-gray-900/50 border border-gray-800 rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
      ...
      {/* Footer Copy */}
      <footer className="w-full max-w-7xl mx-auto px-6 py-8 border-t border-gray-900 text-center text-gray-500 text-sm">
